...
def cover():
    print """
     ...
     """
    runntek(GL+"            ASSALAMUALAIKUM USR DFA ^_^")
    time.sleep(1)
    print " "
    print RR+"  +=========================******************=====================+"
    print GG+"  |••••••••                     INDONESIA                 •••••••••|" 
    print RR+"  +=====================-=XXXXXXXXXXXXXXXXXXXXXX=-=================+"
    print WW+"  |                    MOD BY    : DARK FORCE ARMY                 |"
    print GG+"  |                               (DFA)                            |"  
    print WW+"  |                                                                |"
    print Y+"  |                             ALL ADMIM                          |"
    print WW+"  |----------------------------------------------------------------|"
    print GL+"  |                     GUNAKAN DENGAN BIJAK!!                     |"
    print WW+"  |----------------------------------------------------------------|"
    print RR+"  +================================================================+"
    print GG+"  |••••••••  INGAT INI BRUTE KEBERHASILAN DITANGAN ANDA   •••••••••|"
    print RR+"  +================================================================+"       
...
| | | | |_ / _ \
| |_| |  _/ ___ \
|____/|_|/_/   \_\ \033[96;4mLife Of Programmer\033[92;1m
      """
        print wel
        print " "
